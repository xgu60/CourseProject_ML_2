...
public class BlockDudeLevelConstructor {
	...
	public static State getLevel1(Domain domain){
		...
		BlockDudeState s = new BlockDudeState(
				new BlockDudeAgent(6, 1, 1, false),
				new BlockDudeMap(map),
				BlockDudeCell.exit(0, 1),
				BlockDudeCell.block("b0", 2, 1),
				BlockDudeCell.block("b1", 8, 1)
		);

		return s;
	}

	public static State getLevel1a(Domain domain){
		...
		BlockDudeState s = new BlockDudeState(
				new BlockDudeAgent(20, 1, 1, false),
				new BlockDudeMap(map),
				BlockDudeCell.exit(0, 1),
				BlockDudeCell.block("b0", 5, 1),
				BlockDudeCell.block("b1", 16, 1)
		);
